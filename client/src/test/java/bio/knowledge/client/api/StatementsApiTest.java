...
public class StatementsApiTest {
    ...
    private static StatementsApi api = new StatementsApi();
    ...
    public void getStatementDetailsTest() throws ApiException {
        ...
        BeaconStatementDetails response = api.getStatementDetails(statementId, keywords, pageNumber, pageSize);
    ...
    public void postStatementsQueryTest() throws ApiException {
        ...
        List<Integer> beacons = null;
        BeaconStatementsQuery response = api.postStatementsQuery(source, relations, target, keywords, categories, beacons);
