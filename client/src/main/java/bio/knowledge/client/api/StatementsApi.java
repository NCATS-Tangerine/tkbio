...
public class StatementsApi {
    ...
    private com.squareup.okhttp.Call getStatementDetailsCall(String statementId, List<String> keywords, Integer pageNumber, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/statements/details/{statementId}".replaceAll("\\{format\\}","json")
    ...
    private com.squareup.okhttp.Call getStatementDetailsValidateBeforeCall(String statementId, List<String> keywords, Integer pageNumber, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getStatementDetailsCall(statementId, keywords, pageNumber, pageSize, progressListener, progressRequestListener);
        return call;
     ...
     * @param keywords an array of keywords or substrings against which to filter a reference label (e.g. title) statement evidence citation array. (optional)
     * @param pageNumber (1-based) number of the page to be returned in a paged set of statement.evidence array entries. Defaults to 1.  (optional)
     * @param pageSize number of cited references per page to be returned in a paged set of statement.evidence array entries. Defaults to &#39;10&#39;.  (optional)
     * @return BeaconStatementDetails
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public BeaconStatementDetails getStatementDetails(String statementId, List<String> keywords, Integer pageNumber, Integer pageSize) throws ApiException {
        ApiResponse<BeaconStatementDetails> resp = getStatementDetailsWithHttpInfo(statementId, keywords, pageNumber, pageSize);
        return resp.getData();
    }
     ...
     * @param pageNumber (1-based) number of the page to be returned in a paged set of statement.evidence array entries. Defaults to 1.  (optional)
     * @param pageSize number of cited references per page to be returned in a paged set of statement.evidence array entries. Defaults to &#39;10&#39;.  (optional)
     * @return ApiResponse&lt;BeaconStatementDetails&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BeaconStatementDetails> getStatementDetailsWithHttpInfo(String statementId, List<String> keywords, Integer pageNumber, Integer pageSize) throws ApiException {
        com.squareup.okhttp.Call call = getStatementDetailsValidateBeforeCall(statementId, keywords, pageNumber, pageSize, null, null);
        Type localVarReturnType = new TypeToken<BeaconStatementDetails>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getStatementDetailsAsync(String statementId, List<String> keywords, Integer pageNumber, Integer pageSize, final ApiCallback<BeaconStatementDetails> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getStatementDetailsValidateBeforeCall(statementId, keywords, pageNumber, pageSize, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BeaconStatementDetails>(){}.getType();
     ...
     * @param source a [CURIE-encoded](https://www.w3.org/TR/curie/) identifier of the  exactly matching &#39;source&#39; clique, cliques as identified by other endpoints of the beacon aggregator API.   (required)
     ...
     * @param target a [CURIE-encoded](https://www.w3.org/TR/curie/) identifier of the  exactly matching &#39;target&#39; clique, cliques as identified by other endpoints of the beacon aggregator API.   (optional)
