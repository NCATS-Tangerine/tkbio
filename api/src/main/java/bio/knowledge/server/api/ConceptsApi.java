...
public interface ConceptsApi {
    ...
    @RequestMapping(value = "/concepts",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<InlineResponse2001> getConcepts( @NotNull @ApiParam(value = "array of keywords or substrings against which to match concept names and synonyms", required = true) @RequestParam(value = "q", required = true) List<String> q,
