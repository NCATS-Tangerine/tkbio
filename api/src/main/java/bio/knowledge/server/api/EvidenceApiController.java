...
public class EvidenceApiController implements EvidenceApi {
    ...
    public ResponseEntity<List<InlineResponse2005>> getEvidence(@ApiParam(value = "identifier of evidence subset of cited references",required=true ) @PathVariable("evidenceId") Integer evidenceId,
