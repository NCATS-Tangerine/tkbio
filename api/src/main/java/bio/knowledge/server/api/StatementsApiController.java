...
public class StatementsApiController implements StatementsApi {
    ...
    public ResponseEntity<List<InlineResponse2003>> getStatements( @NotNull @ApiParam(value = "list of concept identifiers (ci) to be used in a search for associated concept-relation statements ", required = true) @RequestParam(value = "ci", required = true) List<String> ci,
