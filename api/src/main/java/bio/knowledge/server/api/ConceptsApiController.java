...
public class ConceptsApiController implements ConceptsApi {
	...
	public ResponseEntity<InlineResponse2001> getConcepts(
			@NotNull @ApiParam(value = "array of keywords or substrings against which to match concept names and synonyms", required = true) @RequestParam(value = "q", required = true) List<String> q,
