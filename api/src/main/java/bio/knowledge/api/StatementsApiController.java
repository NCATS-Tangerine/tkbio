...
import bio.knowledge.model.InlineResponse2003;
...
public class StatementsApiController implements StatementsApi {
    ...
    public ResponseEntity<List<InlineResponse2003>> getStatements( @NotNull @ApiParam(value = "identifier of the query session established by prior POST'ing of a list of concept identifiers of interest ", required = true) @RequestParam(value = "queryId", required = true) String queryId,
