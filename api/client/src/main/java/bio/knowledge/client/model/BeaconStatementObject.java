...
public class BeaconStatementObject {
  ...
  **/
   ...
   * @return category
  **/
  @ApiModelProperty(example = "null", value = "Semantic category of the object concept ((see [Biolink Model](https://biolink.github.io/biolink-model) for the full list of categories). ")
