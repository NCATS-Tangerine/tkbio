...
public class BeaconConcept {
  ...
  **/
   ...
   * @return category
  **/
  @ApiModelProperty(example = "null", value = "Concept category associated with the given concept ((see [Biolink Model](https://biolink.github.io/biolink-model) for the full list of categories). ")
