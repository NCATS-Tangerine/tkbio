...
import bio.knowledge.client.model.BeaconConceptTypes;
...
public class MetadataApi {
     ...
     * @return List&lt;BeaconConceptTypes&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<BeaconConceptTypes> getConceptTypes(List<Integer> beacons) throws ApiException {
        ApiResponse<List<BeaconConceptTypes>> resp = getConceptTypesWithHttpInfo(beacons);
        return resp.getData();
    }
     ...
     * Get a list of types and number of instances in the knowledge source, and a link to the API call for the list of equivalent terminology 
     * @param beacons set of aggregator indices of beacons to constrain types returned  (optional)
     * @return ApiResponse&lt;List&lt;BeaconConceptTypes&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<BeaconConceptTypes>> getConceptTypesWithHttpInfo(List<Integer> beacons) throws ApiException {
        com.squareup.okhttp.Call call = getConceptTypesValidateBeforeCall(beacons, null, null);
        Type localVarReturnType = new TypeToken<List<BeaconConceptTypes>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getConceptTypesAsync(List<Integer> beacons, final ApiCallback<List<BeaconConceptTypes>> callback) throws ApiException {
