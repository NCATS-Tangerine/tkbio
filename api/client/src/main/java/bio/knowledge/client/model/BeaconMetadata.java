 ...
 * BeaconMetadata
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2017-11-06T16:43:58.243-08:00")
public class BeaconMetadata {
  ...
  public BeaconMetadata id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public BeaconMetadata name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public BeaconMetadata url(String url) {
    this.url = url;
    return this;
  }
  ...
  **/
  ...
  public BeaconMetadata description(String description) {
  ...
  **/
  ...
  public BeaconMetadata contact(String contact) {
  ...
  **/
  ...
  public BeaconMetadata wraps(String wraps) {
    this.wraps = wraps;
    return this;
  }
  ...
  **/
  ...
  public BeaconMetadata repo(String repo) {
    this.repo = repo;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BeaconMetadata beaconMetadata = (BeaconMetadata) o;
    return Objects.equals(this.id, beaconMetadata.id) &&
        Objects.equals(this.name, beaconMetadata.name) &&
        Objects.equals(this.url, beaconMetadata.url) &&
        Objects.equals(this.description, beaconMetadata.description) &&
        Objects.equals(this.contact, beaconMetadata.contact) &&
        Objects.equals(this.wraps, beaconMetadata.wraps) &&
        Objects.equals(this.repo, beaconMetadata.repo);
  }
  ...
  public String toString() {
    ...
    sb.append("class BeaconMetadata {\n");
