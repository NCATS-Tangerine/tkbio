...
public class BeaconConceptBeaconEntry {
  ...
  public BeaconConceptBeaconEntry beacon(String beacon) {
    this.beacon = beacon;
    return this;
  }
  ...
  **/
  ...
  public BeaconConceptBeaconEntry id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public BeaconConceptBeaconEntry synonyms(List<String> synonyms) {
    this.synonyms = synonyms;
    return this;
  }

  public BeaconConceptBeaconEntry addSynonymsItem(String synonymsItem) {
  ...
  **/
  ...
  public BeaconConceptBeaconEntry definition(String definition) {
  ...
  **/
  ...
  public BeaconConceptBeaconEntry details(List<BeaconConceptDetail> details) {
    this.details = details;
    return this;
  }

  public BeaconConceptBeaconEntry addDetailsItem(BeaconConceptDetail detailsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BeaconConceptBeaconEntry beaconConceptBeaconEntry = (BeaconConceptBeaconEntry) o;
    return Objects.equals(this.beacon, beaconConceptBeaconEntry.beacon) &&
        Objects.equals(this.id, beaconConceptBeaconEntry.id) &&
        Objects.equals(this.synonyms, beaconConceptBeaconEntry.synonyms) &&
        Objects.equals(this.definition, beaconConceptBeaconEntry.definition) &&
        Objects.equals(this.details, beaconConceptBeaconEntry.details);
  }
  ...
  public String toString() {
    ...
    sb.append("class BeaconConceptBeaconEntry {\n");
