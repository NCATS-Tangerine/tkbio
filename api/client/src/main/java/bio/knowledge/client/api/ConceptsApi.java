...
public class ConceptsApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public BeaconConceptsQuery postConceptsQuery(String keywords, List<String> types, List<Integer> beacons) throws ApiException {
        ApiResponse<BeaconConceptsQuery> resp = postConceptsQueryWithHttpInfo(keywords, types, beacons);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BeaconConceptsQuery> postConceptsQueryWithHttpInfo(String keywords, List<String> types, List<Integer> beacons) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postConceptsQueryAsync(String keywords, List<String> types, List<Integer> beacons, final ApiCallback<BeaconConceptsQuery> callback) throws ApiException {
