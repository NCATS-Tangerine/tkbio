...
public class ConceptsApi {
    ...
    /* Build call for getCliques */
    private com.squareup.okhttp.Call getCliquesCall(String queryId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/cliques/data/{queryId}".replaceAll("\\{format\\}","json")
    ...
    private com.squareup.okhttp.Call getCliquesValidateBeforeCall(String queryId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'queryId' is set
        if (queryId == null) {
            throw new ApiException("Missing the required parameter 'queryId' when calling getCliques(Async)");
        }
        
        
        com.squareup.okhttp.Call call = getCliquesCall(queryId, progressListener, progressRequestListener);
        return call;
     ...
     * @param queryId the query identifier of a concepts query previously posted by the /cliques endpoint (required)
     * @return BeaconCliquesQueryResult
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public BeaconCliquesQueryResult getCliques(String queryId) throws ApiException {
        ApiResponse<BeaconCliquesQueryResult> resp = getCliquesWithHttpInfo(queryId);
        return resp.getData();
    }
     ...
     * Retrieves a list of concept cliques based on  &#39;data ready&#39; from a previously /cliques posted query parameter submission 
     * @param queryId the query identifier of a concepts query previously posted by the /cliques endpoint (required)
     * @return ApiResponse&lt;BeaconCliquesQueryResult&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BeaconCliquesQueryResult> getCliquesWithHttpInfo(String queryId) throws ApiException {
        com.squareup.okhttp.Call call = getCliquesValidateBeforeCall(queryId, null, null);
        Type localVarReturnType = new TypeToken<BeaconCliquesQueryResult>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getCliquesAsync(String queryId, final ApiCallback<BeaconCliquesQueryResult> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCliquesValidateBeforeCall(queryId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BeaconCliquesQueryResult>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for getCliquesQueryStatus */
    private com.squareup.okhttp.Call getCliquesQueryStatusCall(String queryId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/cliques/status/{queryId}".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "queryId" + "\\}", apiClient.escapeString(queryId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getCliquesQueryStatusValidateBeforeCall(String queryId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'queryId' is set
        if (queryId == null) {
            throw new ApiException("Missing the required parameter 'queryId' when calling getCliquesQueryStatus(Async)");
        }
        
        
        com.squareup.okhttp.Call call = getCliquesQueryStatusCall(queryId, progressListener, progressRequestListener);
        return call;
     ...
     * @param queryId an active query identifier as returned by a POST of clique query parameters. (required)
     * @return BeaconCliquesQueryStatus
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public BeaconCliquesQueryStatus getCliquesQueryStatus(String queryId) throws ApiException {
        ApiResponse<BeaconCliquesQueryStatus> resp = getCliquesQueryStatusWithHttpInfo(queryId);
        return resp.getData();
    }
     ...
     * Retrieves the status of a given query about the cliques in the system 
     * @param queryId an active query identifier as returned by a POST of clique query parameters. (required)
     * @return ApiResponse&lt;BeaconCliquesQueryStatus&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BeaconCliquesQueryStatus> getCliquesQueryStatusWithHttpInfo(String queryId) throws ApiException {
        com.squareup.okhttp.Call call = getCliquesQueryStatusValidateBeforeCall(queryId, null, null);
        Type localVarReturnType = new TypeToken<BeaconCliquesQueryStatus>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getCliquesQueryStatusAsync(String queryId, final ApiCallback<BeaconCliquesQueryStatus> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCliquesQueryStatusValidateBeforeCall(queryId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BeaconCliquesQueryStatus>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param pageNumber (1-based) number of the page to be returned in a paged set of query results. Defaults to &#39;1&#39;.  (optional)
     * @param pageSize number of concepts per page to be returned in a paged set of query results. Defaults to &#39;10&#39;.  (optional)
    ...
    /* Build call for postCliquesQuery */
    private com.squareup.okhttp.Call postCliquesQueryCall(List<String> ids, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/cliques".replaceAll("\\{format\\}","json");
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postCliquesQueryValidateBeforeCall(List<String> ids, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'ids' is set
        if (ids == null) {
            throw new ApiException("Missing the required parameter 'ids' when calling postCliquesQuery(Async)");
        }
        
        
        com.squareup.okhttp.Call call = postCliquesQueryCall(ids, progressListener, progressRequestListener);
        return call;
     ...
     * @param ids an array of [CURIE-encoded](https://www.w3.org/TR/curie/)  identifiers of interest to be resolved to a list of concept cliques (required)
     * @return BeaconCliquesQuery
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public BeaconCliquesQuery postCliquesQuery(List<String> ids) throws ApiException {
        ApiResponse<BeaconCliquesQuery> resp = postCliquesQueryWithHttpInfo(ids);
        return resp.getData();
    }
     ...
     * Retrieves the beacon aggregator assigned cliques of equivalent concepts that includes the specified (url-encoded) CURIE identifiers. Note that the clique to which a given concept CURIE belongs may change over time as the aggregator progressively discovers the members of the clique. Any unmatched identifiers will be ignored (e.g. the id couldn&#39;t be found in any of the beacons)  
     * @param ids an array of [CURIE-encoded](https://www.w3.org/TR/curie/)  identifiers of interest to be resolved to a list of concept cliques (required)
     * @return ApiResponse&lt;BeaconCliquesQuery&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BeaconCliquesQuery> postCliquesQueryWithHttpInfo(List<String> ids) throws ApiException {
        com.squareup.okhttp.Call call = postCliquesQueryValidateBeforeCall(ids, null, null);
        Type localVarReturnType = new TypeToken<BeaconCliquesQuery>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postCliquesQueryAsync(List<String> ids, final ApiCallback<BeaconCliquesQuery> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postCliquesQueryValidateBeforeCall(ids, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BeaconCliquesQuery>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
