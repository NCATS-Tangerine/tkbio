...
public class ConceptsApi {
    ...
    private com.squareup.okhttp.Call postConceptsQueryCall(String keywords, List<String> categories, List<Integer> beacons, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postConceptsQueryValidateBeforeCall(String keywords, List<String> categories, List<Integer> beacons, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public BeaconConceptsQuery postConceptsQuery(String keywords, List<String> categories, List<Integer> beacons) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BeaconConceptsQuery> postConceptsQueryWithHttpInfo(String keywords, List<String> categories, List<Integer> beacons) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postConceptsQueryAsync(String keywords, List<String> categories, List<Integer> beacons, final ApiCallback<BeaconConceptsQuery> callback) throws ApiException {
