...
public class ConceptsApi {
    ...
    private com.squareup.okhttp.Call getConceptsCall(List<String> q, List<String> sg, Integer pageNumber, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getConceptsValidateBeforeCall(List<String> q, List<String> sg, Integer pageNumber, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'q' is set
        if (q == null) {
            throw new ApiException("Missing the required parameter 'q' when calling getConcepts(Async)");
        }
        
        
        com.squareup.okhttp.Call call = getConceptsCall(q, sg, pageNumber, pageSize, progressListener, progressRequestListener);
        return call;
     ...
     * @param q array of keywords or substrings against which to match concept names and synonyms (required)
     * @param sg array of semantic groups (specified as codes CHEM, GENE, ANAT, etc.) to which to constrain concepts matched by the main keyword search (see https://metamap.nlm.nih.gov/Docs/SemGroups_2013.txt for the full list of codes)  (optional)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse2001 getConcepts(List<String> q, List<String> sg, Integer pageNumber, Integer pageSize) throws ApiException {
        ApiResponse<InlineResponse2001> resp = getConceptsWithHttpInfo(q, sg, pageNumber, pageSize);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2001> getConceptsWithHttpInfo(List<String> q, List<String> sg, Integer pageNumber, Integer pageSize) throws ApiException {
        com.squareup.okhttp.Call call = getConceptsValidateBeforeCall(q, sg, pageNumber, pageSize, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getConceptsAsync(List<String> q, List<String> sg, Integer pageNumber, Integer pageSize, final ApiCallback<InlineResponse2001> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getConceptsValidateBeforeCall(q, sg, pageNumber, pageSize, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse2001>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
