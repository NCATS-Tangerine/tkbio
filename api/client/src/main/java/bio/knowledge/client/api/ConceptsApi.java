...
public class ConceptsApi {
    ...
    private com.squareup.okhttp.Call getCliqueCall(String identifier, String sessionId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public BeaconCliqueIdentifier getClique(String identifier, String sessionId) throws ApiException {
        ApiResponse<BeaconCliqueIdentifier> resp = getCliqueWithHttpInfo(identifier, sessionId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BeaconCliqueIdentifier> getCliqueWithHttpInfo(String identifier, String sessionId) throws ApiException {
        com.squareup.okhttp.Call call = getCliqueValidateBeforeCall(identifier, sessionId, null, null);
     ...
     */
    public com.squareup.okhttp.Call getCliqueAsync(String identifier, String sessionId, final ApiCallback<BeaconCliqueIdentifier> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCliqueValidateBeforeCall(identifier, sessionId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BeaconCliqueIdentifier>(){}.getType();
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<BeaconConceptWithDetails> getConceptDetails(String cliqueId, List<String> beacons, String sessionId) throws ApiException {
        ApiResponse<List<BeaconConceptWithDetails>> resp = getConceptDetailsWithHttpInfo(cliqueId, beacons, sessionId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<BeaconConceptWithDetails>> getConceptDetailsWithHttpInfo(String cliqueId, List<String> beacons, String sessionId) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getConceptDetailsAsync(String cliqueId, List<String> beacons, String sessionId, final ApiCallback<List<BeaconConceptWithDetails>> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<BeaconConcept> getConcepts(String keywords, String semanticGroups, Integer pageNumber, Integer pageSize, List<String> beacons, String sessionId) throws ApiException {
        ApiResponse<List<BeaconConcept>> resp = getConceptsWithHttpInfo(keywords, semanticGroups, pageNumber, pageSize, beacons, sessionId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<BeaconConcept>> getConceptsWithHttpInfo(String keywords, String semanticGroups, Integer pageNumber, Integer pageSize, List<String> beacons, String sessionId) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getConceptsAsync(String keywords, String semanticGroups, Integer pageNumber, Integer pageSize, List<String> beacons, String sessionId, final ApiCallback<List<BeaconConcept>> callback) throws ApiException {
