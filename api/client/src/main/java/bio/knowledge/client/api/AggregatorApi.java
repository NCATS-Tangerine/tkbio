...
public class AggregatorApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<BeaconLogEntry> getErrors(String sessionId) throws ApiException {
        ApiResponse<List<BeaconLogEntry>> resp = getErrorsWithHttpInfo(sessionId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<BeaconLogEntry>> getErrorsWithHttpInfo(String sessionId) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getErrorsAsync(String sessionId, final ApiCallback<List<BeaconLogEntry>> callback) throws ApiException {
