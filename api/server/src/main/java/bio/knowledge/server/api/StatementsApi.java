...
public interface StatementsApi {
    ...
    @ApiOperation(value = "", notes = "Given a list of [CURIE-encoded](https://www.w3.org/TR/curie/) identifiers of exactly matching concepts, retrieves a paged list of concept-relations where either the subject or object concept matches at least one concept in the input list ", response = InlineResponse2003.class, tags={ "statements", })
    @ApiResponses(value = { 
