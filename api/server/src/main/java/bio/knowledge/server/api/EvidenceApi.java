...
public interface EvidenceApi {
    ...
    ResponseEntity<InlineResponse2004> getEvidence(@ApiParam(value = "local identifier of evidence subset, of cited references supporting a given concept-relationship statement ",required=true ) @PathVariable("evidenceId") String evidenceId,
